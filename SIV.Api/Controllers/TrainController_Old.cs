...
namespace SIV.Controllers
{
    ...
    public class TrainController_Old : ControllerBase
    {
        private readonly SqlSugarClient _db;
        private readonly AppSettings _appSettings;
        private readonly ILogger<TrainController_Old> _logger;
        ...
        public TrainController_Old(
            ILogger<TrainController_Old> logger,
            SqlSugarClient db,
            IMapper mapper,
